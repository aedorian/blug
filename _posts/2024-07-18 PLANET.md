...
We are doing this in the vertex shader. I started with these [this 3D simplex noise shader](https://www.shadertoy.com/view/XsX3zB) functions.
...
{: .tleft }
<img src="../assets/img/planet/patches.PNG" height=200px>
{: .imright }
</div>
