...
<figure style="display: inline-block">
<img src="../assets/img/planet/temperature.PNG" height=200px>
<figcaption>temperature</figcaption>
</figure>
<figure style="display: inline-block">
<img src="../assets/img/planet/humidity.PNG" height=200px>
<figcaption>humidity</figcaption>
</figure>

I added rules depending on the elevation (sea level, beach level, land level and peak level). If the elevation value is at land level, this is how the biome is selected (humidity from left to right and temperature from up to down):
...
<figure style="display: inline-block">
<img src="../assets/img/planet/yeee.PNG" height=200px>
<figcaption>planet biomes</figcaption>
</figure>
<figure style="display: inline-block">
<img src="../assets/img/planet/snowpeaks.PNG" height=200px>
<figcaption>snow peaks on high elevation</figcaption>
</figure>
<figure style="display: inline-block">
<img src="../assets/img/planet/smoothforesttransition.PNG" height=200px>
...
<figure style="display: inline-block">
<img src="../assets/img/planet/planet1.PNG" height=400px>
</figure>
