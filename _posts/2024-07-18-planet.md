...
I added rules depending on the elevation (sea level, beach level, land level and peak level). If the elevation value is at land level, this is how the biome is selected:
