...
Fortunately, a course held this semester focused on graph algorithmics. And by chance, a dataset of 6 to 112 points representing the cities of France was handed out during a practical exercise (I alternate between them to show different examples).
...
<figure style="display: inline-block">
   <img src="../assets/img/graf/toutdelone.PNG" width=700px>
...
<figure style="display: inline-block">
   <img src="../assets/img/graf/startfromrandom.PNG" width=600px>
   <figcaption>21 maximum cities</figcaption>
</figure>
...
<figure style="display: inline-block">
   <img src="../assets/img/graf/differen.PNG" height=350px>
</figure>
<figure style="display: inline-block">
   <img src="../assets/img/graf/okbof.PNG" height=350px>
</figure>
...
Now here's an example of why that couldn't work... (big cluster and super far from others)
...
When running the full algorithm on the 112 cities dataset, we get this path (27 cities):
