...
<figure style="display: inline-block">
   <img src="../assets/img/graf/toutdelone.PNG" height=700px>
</figure>
...
After thinking and researching multiple methods (including brute-forcing everything, using Hamiltonian cycles and using minimum spanning trees algorithms), I came up with this algorithm:
...
It took less than `0.01` second to execute in Python with the 112 cities dataset.
