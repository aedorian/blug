...
<img src="../assets/img/dungen/corner.png" height=40px> <img src="../assets/img/dungen/line.png" height=40px> <img src="../assets/img/dungen/triple.png" height=40px> <img src="../assets/img/dungen/cross.png" height=40px>
...
<figure style="display: inline-block">
   <img src="../assets/img/dungen/d1.png" height=300px>
   <figcaption>a checkerboard helps visualize the tiles better</figcaption>
</figure>
<figure style="display: inline-block">
   <img src="../assets/img/dungen/d2.png" height=300px>
   <figcaption>more tiles</figcaption>
</figure>

I later added these tiles to the tileset. The first is a dead end, and the second adds smaller detail: <img src="../assets/img/dungen/end.png" height=40px> <img src="../assets/img/dungen/big.png" height=40px>

<figure style="display: inline-block">
   <img src="../assets/img/dungen/d3.png" height=300px>
   <figcaption>lots of variation</figcaption>
</figure>
<figure style="display: inline-block">
   <img src="../assets/img/dungen/d4.png" height=300px>
   <figcaption>larger generation</figcaption>
</figure>

I finally added the last tiles to the tileset, especially an empty one with four connexions: <img src="../assets/img/dungen/empty.png" height=40px> <img src="../assets/img/dungen/column.png" height=40px>
...
<figure style="display: inline-block">
   <img src="../assets/img/dungen/d5.png" height=300px>
   <figcaption>little rooms</figcaption>
</figure>
<figure style="display: inline-block">
   <img src="../assets/img/dungen/d6.png" height=300px>
...
<figure style="display: inline-block">
   <img src="../assets/img/dungen/d7.png" height=300px>
   <figcaption>a bit larger rooms</figcaption>
</figure>
<figure style="display: inline-block">
   <img src="../assets/img/dungen/d8.png" height=300px>
...
<figure style="display: inline-block">
   <img src="../assets/img/dungen/output182.gif" height=300px>
</figure>
<figure style="display: inline-block">
   <img src="../assets/img/dungen/output4.gif" height=300px>
</figure>
...
<figure style="display: inline-block">
   <img src="../assets/img/dungen/outputr1.gif" height=300px>
   <figcaption>only "cross" tiles</figcaption>
</figure>
<figure style="display: inline-block">
   <img src="../assets/img/dungen/outputr2.gif" height=300px>
