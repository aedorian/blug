...
wind shader for certain geometry
...
Probably the most important gameplay mechanic, but I kept it for last...

(raycast)

It turns out rebuilding the chunk mesh isn't that expensive. So we can afford rebuilding it directly after modifying a chunk.
