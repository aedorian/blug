...
We also need to check if the ray is going out of the <span style="color:blue;">current chunk's bounds</span>. If it is, just switch chunks using the current chunk's neighbors.
