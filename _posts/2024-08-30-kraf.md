...
<figure style="display: inline-block; image-rendering: pixelated;">
...
A `Chunk` class stores blocks in a `Block blockData[CHUNK_SIZE][HEIGHT_LIMIT][CHUNK_SIZE]` 3D array. It also stores its own position in the world grid.
...
<figure style="display: inline-block">
<img src="../assets/img/kraf/viz_4.PNG" height=350px>
<figcaption>5x5 cube</figcaption>
</figure>
<figure style="display: inline-block">
<img src="../assets/img/kraf/viz_1.PNG" height=350px>
...
Now we need to generate chunks when the player moves around.

After researching on how to make a chunk system, I decided to go with this version.
